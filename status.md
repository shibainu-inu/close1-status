...
## 現在
- 審判: 最新 n=122（予定 09-26 07:10 JST、遅れ 14秒）、今の n=122、参照価格 225.14、登録済み owner 総数 823513（n=122）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=122 区間1 ref=225.14 残りの脚 0 → 今回 0件（上限 1188）
