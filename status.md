...
## 現在
- 審判: 最新 n=171（予定 09-26 11:15 JST、遅れ 22秒）、今の n=171、参照価格 224.77、登録済み owner 総数 882064（n=171）
- flow（n=1〜171）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=171 区間1 ref=224.77 残りの脚 0 → 今回 0件（上限 1188）
