...
## 現在
- 審判: 最新 n=254（予定 09-26 18:10 JST、遅れ 14秒）、今の n=254、参照価格 224.31、登録済み owner 総数 1104601（n=254）
- flow（n=1〜254）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=254 区間1 ref=224.31 残りの脚 0 → 今回 0件（上限 1188）
