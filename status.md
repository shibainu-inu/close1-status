...
## 現在
- 審判: 最新 n=248（予定 09-26 17:40 JST、遅れ 32秒）、今の n=248、参照価格 224.43、登録済み owner 総数 1092021（n=248）
- flow（n=1〜248）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=248 区間1 ref=224.43 残りの脚 0 → 今回 0件（上限 1187）
