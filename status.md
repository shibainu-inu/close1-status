...
## 現在
- 審判: 最新 n=209（予定 09-26 14:25 JST、遅れ 12秒）、今の n=209、参照価格 224.59、登録済み owner 総数 989640（n=209）
- flow（n=1〜209）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=209 区間1 ref=224.59 残りの脚 0 → 今回 0件（上限 1188）
