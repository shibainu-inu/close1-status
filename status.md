...
## 現在
- 審判: 最新 n=257（予定 09-26 18:25 JST、遅れ 13秒）、今の n=257、参照価格 224.24、登録済み owner 総数 1113853（n=257）
- flow（n=1〜257）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=257 区間1 ref=224.24 残りの脚 0 → 今回 0件（上限 1188）
