...
## 現在
- 審判: 最新 n=243（予定 09-26 17:15 JST、遅れ 12秒）、今の n=243、参照価格 224.44、登録済み owner 総数 1079933（n=243）
- flow（n=1〜243）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=243 区間1 ref=224.44 残りの脚 0 → 今回 0件（上限 1188）
