...
## 現在
- 審判: 最新 n=145（予定 09-26 09:05 JST、遅れ 13秒）、今の n=146、参照価格 225.08、登録済み owner 総数 843050（n=145）
- flow（n=1〜145）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=145 区間1 ref=225.08 残りの脚 0 → 今回 0件（上限 1186）
