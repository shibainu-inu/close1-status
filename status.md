...
## 現在
- 審判: 最新 n=147（予定 09-26 09:15 JST、遅れ 15秒）、今の n=147、参照価格 225.09、登録済み owner 総数 844607（n=147）
- flow（n=1〜147）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=147 区間1 ref=225.09 残りの脚 0 → 今回 0件（上限 1186）
