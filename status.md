...
## 現在
- 審判: 最新 n=229（予定 09-26 16:05 JST、遅れ 16秒）、今の n=229、参照価格 224.63、登録済み owner 総数 1031923（n=229）
- flow（n=1〜229）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=229 区間1 ref=224.63 残りの脚 0 → 今回 0件（上限 1188）
