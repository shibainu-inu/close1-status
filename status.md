...
## 現在
- 審判: 最新 n=346（予定 09-27 01:50 JST、遅れ 25秒）、今の n=346、参照価格 224.68、登録済み owner 総数 1552051（n=346）
- flow（n=1〜346）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=346 区間1 ref=224.68 残りの脚 0 → 今回 0件（上限 1186）
