...
## 現在
- 審判: 最新 n=339（予定 09-27 01:15 JST、遅れ 22秒）、今の n=339、参照価格 224.65、登録済み owner 総数 1426436（n=339）
- flow（n=1〜339）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=339 区間1 ref=224.65 残りの脚 0 → 今回 0件（上限 1184）
