...
## 現在
- 審判: 最新 n=277（予定 09-26 20:05 JST、遅れ 33秒）、今の n=277、参照価格 224.41、登録済み owner 総数 1187746（n=277）
- flow（n=1〜277）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=277 区間1 ref=224.41 残りの脚 0 → 今回 0件（上限 1187）
