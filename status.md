...
## 現在
- 審判: 最新 n=318（予定 09-26 23:30 JST、遅れ 22秒）、今の n=318、参照価格 224.50、登録済み owner 総数 1328893（n=318）
- flow（n=1〜318）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=318 区間1 ref=224.50 残りの脚 0 → 今回 0件（上限 1186）
