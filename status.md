...
## 現在
- 審判: 最新 n=111（予定 09-26 06:15 JST、遅れ 14秒）、今の n=111、参照価格 225.01、登録済み owner 総数 800116（n=111）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=111 区間1 ref=225.01 残りの脚 0 → 今回 0件（上限 1188）
