...
## 現在
- 審判: 最新 n=232（予定 09-26 16:20 JST、遅れ 16秒）、今の n=233、参照価格 224.62、登録済み owner 総数 1041474（n=232）
- flow（n=1〜232）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=232 区間1 ref=224.62 残りの脚 0 → 今回 0件（上限 1188）
