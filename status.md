...
## 現在
- 審判: 最新 n=240（予定 09-26 17:00 JST、遅れ 14秒）、今の n=240、参照価格 224.37、登録済み owner 総数 1070107（n=240）
- flow（n=1〜240）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=240 区間1 ref=224.37 残りの脚 0 → 今回 0件（上限 1188）
