...
## 現在
- 審判: 最新 n=219（予定 09-26 15:15 JST、遅れ 12秒）、今の n=219、参照価格 224.52、登録済み owner 総数 1013750（n=219）
- flow（n=1〜219）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=219 区間1 ref=224.52 残りの脚 0 → 今回 0件（上限 1187）
