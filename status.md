...
## 現在
- 審判: 最新 n=114（予定 09-26 06:30 JST、遅れ 13秒）、今の n=114、参照価格 225.14、登録済み owner 総数 807550（n=114）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=114 区間1 ref=225.14 残りの脚 0 → 今回 0件（上限 1188）
