...
## 現在
- 審判: 最新 n=121（予定 09-26 07:05 JST、遅れ 14秒）、今の n=121、参照価格 225.17、登録済み owner 総数 821430（n=121）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=121 区間1 ref=225.17 残りの脚 0 → 今回 0件（上限 1188）
