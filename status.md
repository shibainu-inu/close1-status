...
## 現在
- 審判: 最新 n=297（予定 09-26 21:45 JST、遅れ 16秒）、今の n=297、参照価格 224.32、登録済み owner 総数 1263450（n=297）
- flow（n=1〜297）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=297 区間1 ref=224.32 残りの脚 0 → 今回 0件（上限 1188）
