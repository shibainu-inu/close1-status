...
## 現在
- 審判: 最新 n=170（予定 09-26 11:10 JST、遅れ 17秒）、今の n=170、参照価格 224.75、登録済み owner 総数 878980（n=170）
- flow（n=1〜170）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=170 区間1 ref=224.75 残りの脚 0 → 今回 0件（上限 1188）
