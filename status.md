...
## 現在
- 審判: 最新 n=127（予定 09-26 07:35 JST、遅れ 14秒）、今の n=127、参照価格 225.16、登録済み owner 総数 828646（n=127）
- flow（n=1〜127）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=127 区間1 ref=225.16 残りの脚 0 → 今回 0件（上限 1188）
