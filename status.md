...
## 現在
- 審判: 最新 n=112（予定 09-26 06:20 JST、遅れ 14秒）、今の n=112、参照価格 225.04、登録済み owner 総数 802483（n=112）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=112 区間1 ref=225.04 残りの脚 0 → 今回 0件（上限 1187）
