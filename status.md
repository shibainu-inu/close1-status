...
## 現在
- 審判: 最新 n=186（予定 09-26 12:30 JST、遅れ 18秒）、今の n=186、参照価格 224.63、登録済み owner 総数 932650（n=186）
- flow（n=1〜186）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=186 区間1 ref=224.63 残りの脚 0 → 今回 0件（上限 1188）
