...
## 現在
- 審判: 最新 n=109（予定 09-26 06:05 JST、遅れ 12秒）、今の n=109、参照価格 225.06、登録済み owner 総数 798772（n=109）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=109 区間1 ref=225.06 残りの脚 0 → 今回 0件（上限 1188）
