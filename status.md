...
## 現在
- 審判: 最新 n=126（予定 09-26 07:30 JST、遅れ 14秒）、今の n=126、参照価格 225.15、登録済み owner 総数 827142（n=126）
- flow（n=1〜126）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=126 区間1 ref=225.15 残りの脚 0 → 今回 0件（上限 1188）
