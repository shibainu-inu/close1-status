...
## 現在
- 審判: 最新 n=98（予定 09-26 05:10 JST、遅れ 12秒）、今の n=98、参照価格 225.04、登録済み owner 総数 703870（n=98）
...
- tree.py: 実行中、確定した取引 0件。最新: n=98 区間1 ref=225.04 残りの脚 4096 → 今回 1189件（上限 1189）
