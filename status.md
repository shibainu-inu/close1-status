...
## 現在
- 審判: 最新 n=305（予定 09-26 22:25 JST、遅れ 17秒）、今の n=305、参照価格 224.26、登録済み owner 総数 1288457（n=305）
- flow（n=1〜305）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=305 区間1 ref=224.26 残りの脚 0 → 今回 0件（上限 1186）
