...
## 現在
- 審判: 最新 n=335（予定 09-27 00:55 JST、遅れ 19秒）、今の n=335、参照価格 224.74、登録済み owner 総数 1384974（n=335）
- flow（n=1〜335）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=335 区間1 ref=224.74 残りの脚 0 → 今回 0件（上限 1187）
