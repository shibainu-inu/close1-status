...
## 現在
- 審判: 最新 n=215（予定 09-26 14:55 JST、遅れ 13秒）、今の n=215、参照価格 224.64、登録済み owner 総数 1006542（n=215）
- flow（n=1〜215）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=215 区間1 ref=224.64 残りの脚 0 → 今回 0件（上限 1188）
