...
## 現在
- 審判: 最新 n=100（予定 09-26 05:20 JST、遅れ 14秒）、今の n=100、参照価格 225.03、登録済み owner 総数 722030（n=100）
...
- tree.py: 実行中、確定した取引 2378件。最新: n=100 区間1 ref=225.03 残りの脚 2908 → 今回 1188件（上限 1188）
