...
## 現在
- 審判: 最新 n=176（予定 09-26 11:40 JST、遅れ 18秒）、今の n=176、参照価格 224.70、登録済み owner 総数 896275（n=176）
- flow（n=1〜176）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=176 区間1 ref=224.70 残りの脚 0 → 今回 0件（上限 1187）
