...
## 現在
- 審判: 最新 n=160（予定 09-26 10:20 JST、遅れ 17秒）、今の n=160、参照価格 224.56、登録済み owner 総数 853276（n=160）
- flow（n=1〜160）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=160 区間1 ref=224.56 残りの脚 0 → 今回 0件（上限 1187）
