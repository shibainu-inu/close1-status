...
## 現在
- 審判: 最新 n=115（予定 09-26 06:35 JST、遅れ 13秒）、今の n=115、参照価格 225.25、登録済み owner 総数 810143（n=115）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=115 区間1 ref=225.25 残りの脚 0 → 今回 0件（上限 1188）
