...
## 現在
- 審判: 最新 n=102（予定 09-26 05:30 JST、遅れ 16秒）、今の n=102、参照価格 225.01、登録済み owner 総数 758764（n=102）
...
- tree.py: 実行中、確定した取引 5942件。最新: n=102 区間1 ref=225.01 残りの脚 1126 → 今回 0件（上限 0）
