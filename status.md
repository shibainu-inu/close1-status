...
## 現在
- 審判: 最新 n=235（予定 09-26 16:35 JST、遅れ 15秒）、今の n=235、参照価格 224.53、登録済み owner 総数 1052771（n=235）
- flow（n=1〜235）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=235 区間1 ref=224.53 残りの脚 0 → 今回 0件（上限 1187）
