...
## 現在
- 審判: 最新 n=134（予定 09-26 08:10 JST、遅れ 15秒）、今の n=134、参照価格 225.19、登録済み owner 総数 836144（n=134）
- flow（n=1〜134）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=134 区間1 ref=225.19 残りの脚 0 → 今回 0件（上限 1188）
