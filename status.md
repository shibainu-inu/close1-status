...
## 現在
- 審判: 最新 n=107（予定 09-26 05:55 JST、遅れ 13秒）、今の n=107、参照価格 225.05、登録済み owner 総数 798679（n=107）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=107 区間1 ref=225.05 残りの脚 0 → 今回 0件（上限 1188）
