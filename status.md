...
## 現在
- 審判: 最新 n=250（予定 09-26 17:50 JST、遅れ 15秒）、今の n=250、参照価格 224.43、登録済み owner 総数 1096524（n=250）
- flow（n=1〜250）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=250 区間1 ref=224.43 残りの脚 0 → 今回 0件（上限 1187）
