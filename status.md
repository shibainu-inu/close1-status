...
## 現在
- 審判: 最新 n=269（予定 09-26 19:25 JST、遅れ 28秒）、今の n=269、参照価格 224.48、登録済み owner 総数 1158795（n=269）
- flow（n=1〜269）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=269 区間1 ref=224.48 残りの脚 0 → 今回 0件（上限 1187）
