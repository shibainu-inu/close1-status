...
## 現在
- 審判: 最新 n=123（予定 09-26 07:15 JST、遅れ 13秒）、今の n=123、参照価格 225.15、登録済み owner 総数 824307（n=123）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=123 区間1 ref=225.15 残りの脚 0 → 今回 0件（上限 1188）
