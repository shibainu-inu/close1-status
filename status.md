...
## 現在
- 審判: 最新 n=259（予定 09-26 18:35 JST、遅れ 14秒）、今の n=259、参照価格 224.34、登録済み owner 総数 1121984（n=259）
- flow（n=1〜259）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=259 区間1 ref=224.34 残りの脚 0 → 今回 0件（上限 1188）
