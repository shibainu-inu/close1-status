...
## 現在
- 審判: 最新 n=324（予定 09-27 00:00 JST、遅れ 21秒）、今の n=325、参照価格 224.76、登録済み owner 総数 1347880（n=324）
- flow（n=1〜324）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=325 区間1 ref=224.76 残りの脚 0 → 今回 0件（上限 1185）
