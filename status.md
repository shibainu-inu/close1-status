...
## 現在
- 審判: 最新 n=104（予定 09-26 05:40 JST、遅れ 14秒）、今の n=105、参照価格 225.07、登録済み owner 総数 782788（n=104）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=104 区間1 ref=225.07 残りの脚 0 → 今回 0件（上限 66）
