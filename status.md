...
## 現在
- 審判: 最新 n=205（予定 09-26 14:05 JST、遅れ 17秒）、今の n=205、参照価格 224.62、登録済み owner 総数 981102（n=205）
- flow（n=1〜205）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=205 区間1 ref=224.62 残りの脚 0 → 今回 0件（上限 1187）
