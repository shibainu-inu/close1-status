...
## 現在
- 審判: 最新 n=278（予定 09-26 20:10 JST、遅れ 71秒）、今の n=278、参照価格 224.39、登録済み owner 総数 1191550（n=278）
- flow（n=1〜278）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=278 区間1 ref=224.39 残りの脚 0 → 今回 0件（上限 1188）
