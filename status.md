...
## 現在
- 審判: 最新 n=275（予定 09-26 19:55 JST、遅れ 37秒）、今の n=275、参照価格 224.48、登録済み owner 総数 1180438（n=275）
- flow（n=1〜275）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=275 区間1 ref=224.48 残りの脚 0 → 今回 0件（上限 1188）
