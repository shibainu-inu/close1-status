...
## 現在
- 審判: 最新 n=323（予定 09-26 23:55 JST、遅れ 19秒）、今の n=323、参照価格 224.76、登録済み owner 総数 1344395（n=323）
- flow（n=1〜323）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=323 区間1 ref=224.76 残りの脚 0 → 今回 0件（上限 1186）
