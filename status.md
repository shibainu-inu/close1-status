...
## 現在
- 審判: 最新 n=128（予定 09-26 07:40 JST、遅れ 14秒）、今の n=128、参照価格 225.20、登録済み owner 総数 830341（n=128）
- flow（n=1〜128）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=128 区間1 ref=225.20 残りの脚 0 → 今回 0件（上限 1188）
