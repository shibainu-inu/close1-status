...
## 現在
- 審判: 最新 n=174（予定 09-26 11:30 JST、遅れ 20秒）、今の n=174、参照価格 224.71、登録済み owner 総数 890639（n=174）
- flow（n=1〜174）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=174 区間1 ref=224.71 残りの脚 0 → 今回 0件（上限 1186）
