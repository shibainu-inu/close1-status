...
## 現在
- 審判: 最新 n=308（予定 09-26 22:40 JST、遅れ 20秒）、今の n=308、参照価格 224.27、登録済み owner 総数 1297305（n=308）
- flow（n=1〜308）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=308 区間1 ref=224.27 残りの脚 0 → 今回 0件（上限 1188）
