...
## 現在
- 審判: 最新 n=148（予定 09-26 09:20 JST、遅れ 18秒）、今の n=148、参照価格 225.02、登録済み owner 総数 845411（n=148）
- flow（n=1〜148）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=148 区間1 ref=225.02 残りの脚 0 → 今回 0件（上限 1187）
