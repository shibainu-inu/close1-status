...
## 現在
- 審判: 最新 n=195（予定 09-26 13:15 JST、遅れ 20秒）、今の n=195、参照価格 224.57、登録済み owner 総数 963811（n=195）
- flow（n=1〜195）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=195 区間1 ref=224.57 残りの脚 0 → 今回 0件（上限 1186）
