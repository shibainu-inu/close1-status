...
## 現在
- 審判: 最新 n=154（予定 09-26 09:50 JST、遅れ 15秒）、今の n=154、参照価格 224.60、登録済み owner 総数 848854（n=154）
- flow（n=1〜154）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=154 区間1 ref=224.60 残りの脚 0 → 今回 0件（上限 1186）
