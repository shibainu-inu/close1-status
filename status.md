...
## 現在
- 審判: 最新 n=133（予定 09-26 08:05 JST、遅れ 15秒）、今の n=133、参照価格 225.20、登録済み owner 総数 835642（n=133）
- flow（n=1〜133）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=133 区間1 ref=225.20 残りの脚 0 → 今回 0件（上限 1188）
