...
## 現在
- 審判: 最新 n=274（予定 09-26 19:50 JST、遅れ 32秒）、今の n=274、参照価格 224.47、登録済み owner 総数 1176319（n=274）
- flow（n=1〜274）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=274 区間1 ref=224.47 残りの脚 0 → 今回 0件（上限 1188）
