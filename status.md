...
## 現在
- 審判: 最新 n=273（予定 09-26 19:45 JST、遅れ 29秒）、今の n=273、参照価格 224.48、登録済み owner 総数 1173326（n=273）
- flow（n=1〜273）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=273 区間1 ref=224.48 残りの脚 0 → 今回 0件（上限 1188）
