...
## 現在
- 審判: 最新 n=119（予定 09-26 06:55 JST、遅れ 13秒）、今の n=119、参照価格 225.19、登録済み owner 総数 817933（n=119）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=119 区間1 ref=225.19 残りの脚 0 → 今回 0件（上限 1188）
