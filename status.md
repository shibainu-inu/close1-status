...
## 現在
- 審判: 最新 n=293（予定 09-26 21:25 JST、遅れ 14秒）、今の n=293、参照価格 224.34、登録済み owner 総数 1249922（n=293）
- flow（n=1〜293）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=293 区間1 ref=224.34 残りの脚 0 → 今回 0件（上限 1187）
