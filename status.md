...
## 現在
- 審判: 最新 n=132（予定 09-26 08:00 JST、遅れ 16秒）、今の n=132、参照価格 225.20、登録済み owner 総数 835056（n=132）
- flow（n=1〜132）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=132 区間1 ref=225.20 残りの脚 0 → 今回 0件（上限 1188）
