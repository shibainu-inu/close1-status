...
## 現在
- 審判: 最新 n=113（予定 09-26 06:25 JST、遅れ 13秒）、今の n=113、参照価格 225.05、登録済み owner 総数 805013（n=113）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=113 区間1 ref=225.05 残りの脚 0 → 今回 0件（上限 1187）
