...
## 現在
- 審判: 最新 n=120（予定 09-26 07:00 JST、遅れ 15秒）、今の n=120、参照価格 225.17、登録済み owner 総数 819411（n=120）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=120 区間1 ref=225.17 残りの脚 0 → 今回 0件（上限 1188）
