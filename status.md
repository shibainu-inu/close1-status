...
## 現在
- 審判: 最新 n=270（予定 09-26 19:30 JST、遅れ 30秒）、今の n=270、参照価格 224.49、登録済み owner 総数 1162148（n=270）
- flow（n=1〜270）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=270 区間1 ref=224.49 残りの脚 0 → 今回 0件（上限 1188）
