...
## 現在
- 審判: 最新 n=291（予定 09-26 21:15 JST、遅れ 16秒）、今の n=292、参照価格 224.33、登録済み owner 総数 1241774（n=291）
- flow（n=1〜291）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=291 区間1 ref=224.33 残りの脚 0 → 今回 0件（上限 1185）
