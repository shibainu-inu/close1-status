...
## 現在
- 審判: 最新 n=317（予定 09-26 23:25 JST、遅れ 21秒）、今の n=317、参照価格 224.46、登録済み owner 総数 1326014（n=317）
- flow（n=1〜317）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=317 区間1 ref=224.46 残りの脚 0 → 今回 0件（上限 1184）
