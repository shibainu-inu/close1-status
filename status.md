...
## 現在
- 審判: 最新 n=242（予定 09-26 17:10 JST、遅れ 13秒）、今の n=242、参照価格 224.42、登録済み owner 総数 1076622（n=242）
- flow（n=1〜242）: 自分の取引 settled に見えた分 998件、void に見えた分 0件（どちらも一部しか載らない）
...
- tree.py: 実行中、確定した取引 8243件。最新: n=242 区間1 ref=224.42 残りの脚 0 → 今回 0件（上限 1188）
